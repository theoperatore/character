module.exports = {
  ...
  character: Object.assign(
    {},
    {
      ...
      //  featureId: id of feature this charge belongs to
      charClassCharges: [
        {
          ...
          spells: [
            {
              ...
              name: 'Chill Touch',
              desc:
                "4d8 necro damage (ranged). Target can't heal until start of my next turn. Undead have DIS on Atk rolls until end of my next turn.",
              cast: '1 action',
              range: '120 ft/ 24 sq',
              cmp: 'V,S',
              dur: 'Instant',
            ...
            },
            {
              ...
              name: 'Fire Bolt',
              desc:
                '4d10 fire damage (ranged). Ignites non-held/worn flammable items.',
              cast: '1 action',
              range: '120 ft/24 sq',
              dur: 'Instant',
              cmp: 'VS',
          ...
          spells: [
            {
              ...
              name: 'Mirror Image',
              desc:
                'Makes 3 illusions w/ AC of 10 + [Dex] mod, can use Action to dismiss illusions.  Switch places with an illusion when being attacked, need to roll 6/8/11 or higher to switch w/ an illusion (3/2/1 illusions remaining). An illusion is destroyed when hit by an attack, ignores all other damage/effects.  Spell has no effect on blindsight/truesight creatures.',
              cast: '1 action',
              range: 'Self',
              cmp: 'V,S',
              dur: '1 minute',
          ...
          spells: [
            {
              ...
              name: 'Fireball',
              desc:
                '8d6 fire damage vs Dex save for half dmg. Ignites non-held/worn flammable objects.Fire spreads around corners.',
              cast: '1 action',
          ...
          spells: [
            {
              ...
              name: 'Beard',
              desc:
                'Call upon the mighty Beard gods for any beard-ly good or favor',
              cast: '1 action',
              range: 'self',
      ...
      charHitPoints: {
        ...
        maximum: 26,
        temporary: 0,
        hitDice: ['ralf-hit-dice-0', 'ralf-hit-dice-1'],
        hitDiceDefinitions: {
          'ralf-hit-dice-0': {
            id: 'ralf-hit-dice-0',
            type: 'd8',
        ...
        containers: [
          {
            id: 'ralf-container-1',
            name: 'Backpack',
            items: ['ralf-equipment-3', 'ralf-equipment-1', 'ralf-equipment-2'],
            default: true,
          },
          {
            id: 'ralf-container-2',
            name: 'Belt Pouch',
            items: ['ralf-equipment-4'],
          },
        ],
        allItems: {
          'ralf-equipment-1': {
            ...
            desc:
              'Can be used to grab onto things and is basically just another hand',
            id: 'ralf-equipment-1',
          },
          'ralf-equipment-2': {
            name: 'Lute',
      ...
      //  desc: a description
      //  classChargesId: classCharge Id (only if gives charges)
      //  type: glyph type to show next to name; PASSIVE, ATTACK, SPELL, DEFENSE
      //  id: some identifier for this feature
      charFeatures: [
        {
          name: 'Crazy Wise Gnome',
          desc:
            "Am I crazy? Or am I wise? That's up to you to find out and for me to know forever.",
          type: 'PASSIVE',
          id: 'ralf-feature-1',
        },
        {
        ...
        },
        {
          name: 'Beard Shield',
          desc:
            '+2 to AC because a Beard that is prehensile can help stop any sort of attack.',
          type: 'DEFENSE',
          id: 'ralf-feature-4',
        },
        {
          name: 'Prehensile Beard',
          desc:
            'Gains ability to grab things with beard. Also allows to use Beard Whips class charges. Number of Charges = character level',
          type: 'ATTACK',
          id: 'ralf-feature-5',
